...
<head>
	<title>ReddRockMusic | Home</title>
	<meta charset="UTF-8">
	...
	<div class="wrapper">
		...
		<div class="footer">
			<ul class="footer-menu">
				<li><a target="_blank" href="https://twitter.com/reddrockmusic"><i class="fa fa-2x fa-twitter-square" aria-hidden="true"></i></a></li>
				<li><a target="_blank" href="https://www.instagram.com/reddrockmusic"><i class="fa fa-2x fa-instagram" aria-hidden="true"></i></a></li>
			</ul>
		</div>
</body>
</html>